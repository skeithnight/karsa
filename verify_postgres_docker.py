...
from karsa.regime.domain.models import RegimeSession, RegimeSnapshot, RegimeTransition
from karsa.regime.domain.value_objects import RegimeClassification, SignalConfidenceScore
from karsa.regime.domain.repositories import ConcurrencyError, ImmutableUpdateError
from karsa.regime.infrastructure.postgres_regime_repositories import (
...
def pg_engine():
    ...
    engine = sa.create_engine('postgresql://karsa:karsa_password@postgres:5432/karsa_db')
